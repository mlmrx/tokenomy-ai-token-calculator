...
const companyStats: CompanyStatType[] = [
  ...
  {
    name: "Amazon",
    ceo: "Jeff Bezos", // Changed from Andy Jassy
    position: "Executive Chairman", // Updated position for Jeff Bezos
    aiFocusArea: "Cloud AI services, e-commerce AI, and voice assistants",
    flagshipAIProduct: "AWS Bedrock / Alexa",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Jeff_Bezos_visits_LAAFB_SMC_%283908618%29_%28cropped%29.jpeg/250px-Jeff_Bezos_visits_LAAFB_SMC_%283908618%29_%28cropped%29.jpeg", // Jeff Bezos image URL
